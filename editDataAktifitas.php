                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Ubah Data Aktifitas</h1>
                                        </div>
                                        <?php
                                        ...
                                        ?>
                                                <form class="user" action="activityController.php" method="post">
                                                    ...
                                                    <input type="hidden" class="form-control form-control-user" name="key_child" value="<?= $key_child; ?>">
                                                    <div class="form-group row">
                                                        <label for="" style="color: black;">Tanggal Aktifitas :</label>
                                                        <div class="col-sm-12 mb-3 mb-sm-0">
                                                            <input type="text" class="form-control form-control-user" name="dateAct" readonly=true value="<?= $key; ?>" placeholder="Tanggal Aktifitas">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="" style="color: black;">Nama Aktifitas :</label>
                                                        <div class="col-sm-12 mb-3 mb-sm-0">
                                                            <input type="text" class="form-control form-control-user" name="activity" placeholder="Nama Aktifitas" value="<?= $getdata['activity']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12 mb-3 mb-sm-0">
                                                            <input type="text" class="form-control form-control-user" name="noted" placeholder="Catatan" value="<?= $getdata['noted']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12 mb-3 mb-sm-0">
                                                            ...
                                                            <script src="js/editAct.js" type="text/javascript"></script>
                                                            <input type="hidden" name="imageUrl" id="imageUrl" value="<?= $getdata['imageUrl']; ?>">
                                                            <input type="hidden" name="videoUrl" id="videoUrl" value="<?= $getdata['videoUrl']; ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <button type="submit" name="edit_act" class="btn btn-primary btn-user btn-block">Ubah Data</button>
                                                </form>
                                        <?php
                                            }
                                        }
