                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Tambah Data Pengasuh</h1>
                                        </div>
                                        <?php
                                        if (isset($_SESSION['verified_user_id'])) {
                                            $uid = $_SESSION['verified_user_id'];
                                        ...
                                        <form class="user" action="caretakerController.php" method="post">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12 mb-3 mb-sm-0">
                                                    <input type="text" class="form-control form-control-user" name="nama_pengasuh" placeholder="Nama Pengasuh">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-user" name="alamat_pengasuh" placeholder="Alamat">
                                            </div>
                                            <div class="form-group row">
                                                <label for="" style="color: black;">Nomor Handphone Pengasuh :</label>
                                                <div class="col-sm-12 mb-3 mb-sm-0">
                                                    <input type="number" class="form-control form-control-user" name="phone" placeholder="No Handphone">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="" style="color: black;">Tanggal Mulai Bekerja Pengasuh :</label>
                                                <div class="col-sm-12 mb-3 mb-sm-0">
                                                    <input type="text" class="form-control form-control-user" name="tanggal_masuk" onfocus="(this.type='date')" placeholder="Tanggal Mulai Bekerja">
                                                </div>
                                            </div>
                                            <button type="submit" name="simpan_pengasuh" class="btn btn-primary btn-user btn-block" onclick="window.location.href='lihatDataPengasuh.php'">Simpan Data</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
